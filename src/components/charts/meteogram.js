...
export function Meteogram(json, container) {
...
Meteogram.prototype.parseYrData = function() {
  ...
  this.json.properties.timeseries.forEach((node, i) => {
    ...
    var localtime = new Date(Date.parse(node.time));
    localtime.setMinutes(localtime.getMinutes() - timezone);

    const x = Date.parse(localtime),
